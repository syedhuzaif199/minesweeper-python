...
class Board(object):
    ...
    def setMines(self,firstClicked):
        #tileSet: set of tiles from which 'numMines' number of mines will chosen at random.
        #tileSet must exclude the initially clicked tile and all the tiles around it, which is achieved by subtracting the set of tiles to be excluded from the tileSet
